...
public class PlayerMove : MonoBehaviour
{
    ...
    void gun(int weaponType)
    {
        ...
        /*
        GameObject projectileObject = Instantiate(projectileLaunch, rigidbody2d.position + Vector2.up * 0.5f, Quaternion.identity);//NO ROTATION
        WeaponFire projectile = projectileObject.GetComponent<WeaponFire>();
        projectile.AmmoType(weaponType);
        projectile.Launch(bulletSpeed);
        */
    }
}
